# Sexology Safety and High-Risk Routing

Read this reference only when the user may be a minor, adult status is unclear
before explicit sexual exploration or durable recording, kink or another
sexual activity carries a plausible risk of serious injury or death, or a
sexual disclosure involves someone who cannot consent. Do not load it for an
...
location when the threshold matters, not an exact birth date. Do not delay an
urgent safety response to complete the check.

If the user is a minor or adult status remains unclear, keep support factual,
age-appropriate, and non-erotic. Do not request explicit detail or coach sexual
activity. Continue consent, body-safety, health, and help-seeking support under
the child and dependent-adult rules in the installed safety reference. Do not
create a durable record of a minor's explicit sexual content.
...
[Kink and Polyamory Aware Professionals Directory (KAP)](https://www.kapprofessionals.org/business-directory-2/)
are starting points. KAP's
[own notice](https://www.kapprofessionals.org/) says that it neither endorses
nor recommends listed professionals and that NCSF does not verify or screen
their inclusion. Independently check credentials, licensure, jurisdiction,
competence, complaints, and fit.
