...
treat screening as diagnosis, recommend a medication or pharmacologically
active product, or advise starting, stopping, switching, dosing, or scheduling
one. If the request signals immediate danger, stop research and use the
available Psychology Companion safety capability or verified local emergency
help.

## Research workflow

1. Clarify the decision or goal the evidence could change. Do not turn a
   supportive conversation into a literature review without a material need.
2. Form a focused question with population, problem or exposure, comparator
   when useful, and decision-important outcomes.
3. Search current primary and authoritative sources. Prefer official guidance,
   systematic reviews, and directly applicable peer-reviewed studies.
4. Check currency, status, population fit, design, bias, indirectness,
   uncertainty, effect size, harms, burden, and conflicts of interest.
5. Separate direct evidence, extrapolation, hypothesis, and unknown. Never
   convert association into causation without adequate support.
6. Give the practical conclusion, calibrated confidence, most important limit,
   and direct source links. Say when live verification was unavailable.

For screening or monitoring, read
[psychometric-instruments.md](references/psychometric-instruments.md) only as a
dated starting registry, then recheck intended use, language and population
validation, recall period, scoring, interpretation, and rights. Commercial
