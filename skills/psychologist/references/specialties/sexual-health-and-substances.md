# Sexual Health and Sexualized Substance Use

Read this reference for a sexuality concern involving physical symptoms,
infection, HIV or another STI, reproductive or fertility questions, medication
effects, or sexualized substance use. Do not load it for an ordinary
psychological or relational sexuality concern without one of those triggers.

This reference supplements [sexology.md](sexology.md). Use current official
medical guidance and the installed safety reference whenever urgency or a
clinical decision is involved.
...
irresponsibility, or a sexual dysfunction. Do not infer behavior, risk,
attractiveness, consent, or relationship viability from status alone. Use the
user's language; `serodifferent` may be preferable to `serodiscordant`, but do
not impose either term.

Separate diagnosis, current treatment or viral-suppression information, actual
transmission routes, other sexual-health needs, relationship agreements,
stigma, and the user's emotional or sexual concern. After checking current
official guidance, explain U=U accurately: a person living with HIV who takes
treatment and maintains an undetectable viral load has zero risk of sexually
transmitting HIV. Do not extrapolate U=U to other STIs, shared injection
equipment, pregnancy, birth, or breastfeeding. Testing, vaccination, PrEP,
PEP, treatment, and conception planning require current official guidance and
...
disclosure is always or never legally required; verify current local law or
route the question to qualified legal or clinical support.

## Chemsex and sexualized substance use

Treat chemsex or other sexualized substance use as a possible interaction among
substance effects, consent capacity, sexual health, sleep, mental health,
relationships, minority stress, and context—not as an orientation, identity,
or diagnosis. Use the user's own term and do not force a narrow definition or
assume which substances, practices, partners, or communities are involved.

If use is current, first check immediate consciousness, breathing, severe
...
substance-use support. Do not provide dosing, mixing, timing, sourcing, or
injection-technique instructions. Use current official guidance for infection,
exposure, testing, vaccination, or treatment decisions.
